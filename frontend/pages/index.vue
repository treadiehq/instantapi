      ...
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-0">
        <div class="flex items-center justify-between h-12">
          ...
          <nav class="flex items-center space-x-4">
            ...
            <NuxtLink to="/login" class="text-sm btn-secondary py-1.5! px-4! flex items-center gap-2">
              <span>Sign in</span>
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" class="size-4"><path fill-rule="evenodd" d="M10 18a8 8 0 1 0 0-16 8 8 0 0 0 0 16ZM6.75 9.25a.75.75 0 0 0 0 1.5h4.59l-2.1 1.95a.75.75 0 0 0 1.02 1.1l3.5-3.25a.75.75 0 0 0 0-1.1l-3.5-3.25a.75.75 0 1 0-1.02 1.1l2.1 1.95H6.75Z" clip-rule="evenodd"></path></svg>
            </NuxtLink>
          </nav>
        </div>
      </div>
                ...
                <div>
                  ...
                  <div class="flex justify-between items-end p-4 border-t border-gray-500/10">
                    ...
                    <button
                      ...
                      class="btn-primary w-auto h-10 text-sm py-2 ml-2 flex items-center gap-2 min-w-[140px] justify-center"
                    >
                      <!-- Loading Spinner -->
