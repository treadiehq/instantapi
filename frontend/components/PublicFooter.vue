      ...
      <div class="border-t border-transparent flex flex-col md:flex-row items-center justify-between py-6">
        <div class="flex items-center justify-center gap-3 relative">
          <p class="text-xs leading-6 font-medium text-gray-500 xl:text-center">
            &copy; {{ currentYear }} Treadie, Inc.
          </p>
					<span class="text-gray-500/50 text-xs">|</span>
          <div class="flex space-x-6 items-center md:mt-0 mt-4">
            <NuxtLink
              to="/terms"
              class="text-xs font-medium leading-6 hover:text-blue-300 text-gray-500"
            >
              Terms
            </NuxtLink>
            <NuxtLink
        ...
        <div class="flex space-x-6 items-center md:mt-0 mt-4">
          ...
          >
            ...
            <svg aria-label="X formerly known as Twitter" fill="currentColor" class="h-4 w-4" viewBox="0 0 22 20">
